...
export function LoginScreen({
  ...
  async function handleReset() {
    ...
    if (ok) alert('Te enviamos un correo para restablecer la contraseña.');
  }
  ...
  return (
    <div className="loginPage">
      ...
      <div className="loginCard">
        ...
        {mode === 'register' && (
          <div className="hint">Te vamos a enviar un correo para verificar tu cuenta antes de usar la app.</div>
        )}
